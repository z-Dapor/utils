 ...
 * Description: check is vaild
 * History:
 * <author>          <time>          <version>          <desc>
 * 臧浩鹏           13:53           v0.1              check is vaild
 */
 ...
 * from that class. add this code to the code base in order to reduce external
 * dependencies.
 */
public final class Preconditions {
  ...
  public static void main(String[] args) {
    String format = format("this is a %s test %s", "little","hh");
